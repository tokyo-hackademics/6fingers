...
public class QuestionListDetailActivity extends ActionBarActivity implements QuestionListDetailFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(QuestionListDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(QuestionListDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_question_list_detail, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, ElarmActivity.class));
            return true;
        }
